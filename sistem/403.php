<?php
// 403 - Erişim Engellendi. .htaccess içindeki "ErrorDocument 403" satırı
// ile buraya gelinir. Admin panelinden ("Hata Sayfaları") özel bir mesaj
// girilmişse config/hata-mesaji-403.txt dosyasından okunur.
http_response_code(403);

$kok = '/gebze-belediyesi';
$mesajDosyasi = '../config/hata-mesaji-403.txt';
...
<head>
    ...
    <title>Erişim Engellendi | Gebze Belediyesi</title>
...
<div class="container py-5 text-center" style="min-height:100vh; display:flex; flex-direction:column; justify-content:center;">
    ...
    <h1 class="fw-bold" style="font-size:5rem; color: var(--lacivert-koyu);">403</h1>
    <h4 class="fw-bold mb-3">Erişim Engellendi</h4>
    <p class="text-muted mb-4">
        <?php if ($ozelMesaj !== ''): ?>
            <?php echo nl2br(htmlspecialchars($ozelMesaj)); ?>
        <?php else: ?>
            Bu sayfaya ya da klasöre erişim izniniz yok. Yanlış bir bağlantıya tıklamış olabilirsiniz.
        <?php endif; ?>
    </p>
    <div>
